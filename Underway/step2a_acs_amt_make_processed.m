function acsout = step2a_acs_amt_make_processed(acs, dailyfile, idays, acs_lim, FORCE, acstype)
   ...
   med_fi_a = median(tmp_fi_a,2, 'omitnan'); %<============= FI: this is resulting in all NaNs
   ...
   med_fi_c = median(tmp_fi_c,2, 'omitnan');
   ...
   med_fi_a_u = median(tmp_fi_a_u, 2, 'omitnan');
   ...
   med_fi_c_u = median(tmp_fi_c_u, 2, 'omitnan');
