function tmp = step2_uway();
   ...
   cd("/Users/thefed/Insync/fed@udel.edu/Working Folder/AMT/Rigs/IOP_Underway/Full_Processing/Source/Code_tjor/DY157_Underway-main/Underway")
   ...
   jdays = jday_in; %FI, because seems like there's been a swap in nomenclature
   ...
   first_day =  32%find_index_strdate_in_glob(fn_saved, sprintf("%d", jday_in(1))); % follows from ini and end dates
   last_day = 32%find_index_strdate_in_glob(fn_saved, sprintf("%d", jday_in(end)));
