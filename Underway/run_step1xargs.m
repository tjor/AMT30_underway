  ...
  % Load paths
   ...
   % day is processed if WAP file exists for the WAPhour hour
   ...
   for i= 1: size(strdates,1)
      itmp = find_index_strdate_in_glob(WAPdays,strcat('_0', num2str(jdays(i)), '_')) # index of jday: tjor mod to string-reading as `jday' was a non-unique ID (`_jday_' is)      
